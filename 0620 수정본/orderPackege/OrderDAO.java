...
public class OrderDAO {
	...
	public int returnInt(String productId) {
		if(productId != "")
	...
	public ArrayList<OrderListDTO> getOrder(String id) throws SQLException, NamingException {
		...
		String sql = "select o.regtime, p.thumbnailLink, p.name, p.price, o.quantity, p.productId from productInfo p join orderlist o on p.productid = o.productid where o.memberid = ? order by o.regtime desc";
