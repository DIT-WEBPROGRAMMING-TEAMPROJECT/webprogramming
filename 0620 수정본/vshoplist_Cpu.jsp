...
<%
	...
	ArrayList<ProductDTO> dtos = productDAO.vshoplistSetting(1);
		...
		<span class = "btnspan" style = "width : 50px">
			...
			<script type="text/javascript">
				...
				function tdSet(id) {
					...
					$(parent.document).find('#tdCpuName').html(arrayId[0]);
					$(parent.document).find('#tdCpuPrice').html(arrayId[1]);
					$(parent.document).find('.cpuId').val(arrayId[2]);
				}
			</script>
		</span>
	</div>
