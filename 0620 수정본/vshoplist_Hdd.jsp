...
<%
	...
	ArrayList<ProductDTO> dtos = productDAO.vshoplistSetting(5);
		...
		<span class = "btnspan" style = "width : 50px">
			...
			<script type="text/javascript">
				...
				function tdSet(id) {
					...
					$(parent.document).find('#tdHddName').html(arrayId[0]);
					$(parent.document).find('#tdHddPrice').html(arrayId[1]);
					$(parent.document).find('.hddId').val(arrayId[2]);
				}
			</script>
		</span>
	</div>
