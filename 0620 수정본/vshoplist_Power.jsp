...
<%
	...
	ArrayList<ProductDTO> dtos = productDAO.vshoplistSetting(8);
		...
		<span class = "btnspan" style = "width : 50px">
			...
			<script type="text/javascript">
				...
				function tdSet(id) {
					...
					$(parent.document).find('#tdPowerName').html(arrayId[0]);
					$(parent.document).find('#tdPowerPrice').html(arrayId[1]);
					$(parent.document).find('.powerId').val(arrayId[2]);
				}
			</script>
		</span>
	</div>
