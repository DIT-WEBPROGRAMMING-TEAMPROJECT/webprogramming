...
<%
	...
	ArrayList<ProductDTO> dtos = productDAO.vshoplistSetting(7);
		...
		<span class = "btnspan" style = "width : 50px">
			...
			<script type="text/javascript">
				...
				function tdSet(id) {
					...
					$(parent.document).find('#tdCaseName').html(arrayId[0]);
					$(parent.document).find('#tdCasePrice').html(arrayId[1]);
					$(parent.document).find('.caseId').val(arrayId[2]);
				}
			</script>
		</span>
	</div>
