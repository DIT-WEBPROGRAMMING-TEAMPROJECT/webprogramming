                        ...
                        <div class="blog_right_sidebar">
                        	...
                        	<div style = "float : right;">
								<form action="vshop_basket.jsp" method="post">
	                            	...
	                            	<input type="submit" class="btn_3" value="장바구니">		
								</form>
                        	</div>
                        	<div style = "float : right;">
                        		<form action="vshop_buy.jsp" method="post">
	                            	...
	                            	<input type="submit" class="btn_3" value="즉시구매">						
								</form>
                        	</div>
                        	<%}else {%>	
                        		<button class="btn_3" id="btnBasket" style = "float : right;">장바구니</button>
                        		<button class="btn_3" id="btnBuy" style = "float : right;">즉시구매</button>
                        	<%}%>
                        	<script type="text/javascript">
