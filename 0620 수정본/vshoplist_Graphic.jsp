...
<%
	...
	ArrayList<ProductDTO> dtos = productDAO.vshoplistSetting(6);
		...
		<span class = "btnspan" style = "width : 50px">
			...
			<script type="text/javascript">
				...
				function tdSet(id) {
					...
					$(parent.document).find('#tdGraphicName').html(arrayId[0]);
					$(parent.document).find('#tdGraphicPrice').html(arrayId[1]);
					$(parent.document).find('.graphicId').val(arrayId[2]);
				}
			</script>
		</span>
	</div>
