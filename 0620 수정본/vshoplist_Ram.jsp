...
<%
	...
	ArrayList<ProductDTO> dtos = productDAO.vshoplistSetting(2);
		...
		<span class = "btnspan" style = "width : 50px">
			...
			<script type="text/javascript">
				...
				function tdSet(id) {
					...
					$(parent.document).find('#tdRamName').html(arrayId[0]);
					$(parent.document).find('#tdRamPrice').html(arrayId[1]);
					$(parent.document).find('.ramId').val(arrayId[2]);
				}
			</script>
		</span>
	</div>
