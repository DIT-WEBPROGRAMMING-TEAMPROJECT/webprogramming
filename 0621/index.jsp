...
<%
	...
	ArrayList<ProductDTO> dtos = productDAO.IndexPageSet();
                        ...
                        <div class="row justify-content-between align-items-center">
                            <div class="col-xl-8 col-lg-8 col-md-8 col-sm-8">
                                <div class="hero__caption">
                                    <h1 data-animation="fadeInLeft" data-delay=".4s" data-duration="2000ms">Select Your New Perfect Computer</h1>
                                    
                                    <!-- Hero-btn -->
                                    <div class="hero__btn" data-animation="fadeInLeft" data-delay=".8s" data-duration="2000ms">
                                        <a href="shop.jsp" class="btn hero-btn">Shop Now</a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-3 col-md-4 col-sm-4 d-none d-sm-block">
                                <div class="hero__img" data-animation="bounceIn" data-delay=".4s">
                                    <img src="assets/img/hero/product_5_20170223141345_58ae7d992b500.png" alt="" class=" heartbeat">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <a href="item.jsp?id=<%=dto.getProductId()%>">
                            <div class="product-img">
                                <img src="http://localhost:8080/FinalTest/uploadFiles/<%=dto.getThumbnailLink()%>" alt="">
                            </div>
