                ...
                <div class="row">
                    <div class="col-lg-6 mb-6 mb-lg-6">
                        <div class="blog_left_sidebar">
                        	<iframe src = "vshoplist.jsp" width = "585px" height = "1000px">
                    ...
                    <div class="col-lg-6">
                        <div class="blog_right_sidebar">
                        	<table class = "table table-bordered" id = "tableId">
                        		<tr>
                        			<th onclick="javascript:HighlightRow(this)">CPU</th>
                        			<td>
                        				
                        			</td>
                        		</tr>
                        		<tr>
                        			<th onclick="javascript:HighlightRow(this)">RAM</th>
                        			<td>
                        			</td>
                        		</tr>
                        		<tr>
                        			<th onclick="javascript:HighlightRow(this)">메인보드</th>
                        			<td>
                        			</td>
                        		</tr>
                        		<tr>
                        			<th onclick="javascript:HighlightRow(this)">그래픽카드</th>
                        			<td>
                        			</td>
                        		</tr>
                        		<tr>
                        			<th onclick="javascript:HighlightRow(this)">SSD</th>
                        			<td>
                        			</td>
                        		</tr>
                        		<tr>
                        			<th onclick="javascript:HighlightRow(this)">HDD</th>
                        			<td>
                        			</td>
                        		</tr>
                        		<tr>
                        			<th onclick="javascript:HighlightRow(this)">파워</th>
                        			<td>
                        			</td>
                        		</tr>	
                        		<tr>
                        			<th onclick="javascript:HighlightRow(this)">케이스</th>
                        			<td>
                        			</td>
                        		</tr>
                        		<tr>
