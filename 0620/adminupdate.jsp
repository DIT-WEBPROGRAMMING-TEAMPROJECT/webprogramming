                        	...
                        	<div class="blog_left_sidebar">
                            	<article class="blog_item">
                                	<div class="blog_item_img">
			                       		...
			                       		<input type = "file" class = "btn-outline-primary" id="Thumbnail" value = "<%=productDTO.getThumbnailLink()%>>"> 
                    	...
                    	<div class="col-lg-6">
                        	<div class="blog_right_sidebar">
                            	<aside class="single_sidebar_widget post_category_widget">
                                	<ul class="list cat-list">
                                    	<li>
	                                		제품명 : <input type = "text" class="form-control"  id="name" value="<%=productDTO.getName()%>" readonly>
	                                	</li>
	                               		 <li>
	                                		종류 : 
                                        	<select class="form-control"  id="productCode" value="<%=productDTO.getProductCode()%>">
											  <option value="01">CPU</option>
											  <option value="02">RAM</option>
											  <option value="03">메인보드</option>
											  <option value="04">그래픽카드</option>
											  <option value="05">SSD</option>
											  <option value="06">HDD</option>
											  <option value="07">케이스</option>
											  <option value="08">파워</option>
											</select>
                                    	</li>
                                    	<li>
                                    	    가격 : <input type = "text" class="form-control"  id="price" name="price" value="<%=productDTO.getPrice()%>">
                                    	</li>
										<li>
											보유수량 : <input type = "text" class="form-control"  id="stock" name="stock" value="<%=productDTO.getStock()%>">
                                    	</li>
                                    	<li>
                                    		<input type = "submit" class = "btn btn-danger"  value = "제품수정">
                                	</ul>
                            	</aside>
                        	</div>
                    	</div>
                   		<div class="blog_details">
                    		<table class = "table table-bordered">
                    			...
                    			<tr>
                    				<th>
                    					<input type = "file" class = "btn-outline-primary"  value = "제품상세정보<%=productDTO.getDetailedLink()%>">
