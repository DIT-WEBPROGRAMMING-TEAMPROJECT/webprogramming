                        	...
                        	<div class="blog_left_sidebar">
                            	<article class="blog_item">
                                	<div class="blog_item_img">                       			
                       				<!-- 제품사진 -->
                       				<input type = "file" class = "btn-outline-primary"  value = "제품사진" id="thumbnailLink" name="thumbnailLink"> 
                       		    	</div>                           
                            	</article>
                    ...
                    <div class="col-lg-6">
                        <div class="blog_right_sidebar">
                            <aside class="single_sidebar_widget post_category_widget">
                                	...
                                	<ul class="list cat-list">
	                                	<li>
	                                		제품명 : <input type = "text" id="name" name="name" class="form-control" >	                                
	                                	</li>
	                                	<li>
	                                		종류 : 
                                    	...
                                    	<li>
                                        	가격 : <input type = "text" class="form-control" id="price" name="price">
                                    	</li>
										<li>
											보유수량 : <input type = "text" class="form-control" id="stock" name="stock">				
                                    	</li>                                    
                                    	<li>
                                    		<input type = "submit" class = "btn btn-danger"  value = "제품등록">
                                    	</li>
                                	</ul>
                            	</aside>
                        	</div>
                    	...
                    	<div class="blog_details">
                    		<table class = "table table-bordered">
                    			...
                    			<tr>
                    				<td><input type = "file" class = "btn-outline-primary"  value = "제품상세정보" id="detailedLink" name="detailedLink"></td>
                    			</tr>
                    		</table>
                    	</div>
                    </form>
